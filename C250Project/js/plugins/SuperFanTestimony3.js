...
var BHell = (function (my) {
	...
	var BHell_Emitter_SuperFan_T3 = my.BHell_Emitter_SuperFan_T3 = function () {
        this.initialize.apply(this, arguments);
    };
	
	BHell_Emitter_SuperFan_T3.prototype = Object.create(my.BHell_Emitter_Base.prototype);
    BHell_Emitter_SuperFan_T3.prototype.constructor = BHell_Emitter_SuperFan_T3;
	
    BHell_Emitter_SuperFan_T3.prototype.initialize = function (x, y, params, parent, bulletList) {
    ...
    BHell_Emitter_SuperFan_T3.prototype.shoot = function () {
...
var BHell = (function (my) {
	...
	BHell_Enemy_SuperFanTestimony3_p1.prototype.initialize = function(x, y, image, params, parent, enemyList) {
		...
		this.emitters.push(new my.BHell_Emitter_SuperFan_T3(this.x, this.y, emitterParams, parent, my.enemyBullets));
