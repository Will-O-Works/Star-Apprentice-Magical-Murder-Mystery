...
homing and sin patterns (unfinished)
@param quit
@desc Quit string.
@default Quit
...
BHell_Bullet.prototype.hit_effect = function() {
...
/**
 * Hit Effect class when player's bullet hits an enemy by V.L. 10/16/2020 
 * @constructor
 * @memberOf BHell
 * @extends BHell.BHell_Sprite
 */
var BHell_Hit_Effect = my.BHell_Hit_Effect = function() {
    this.initialize.apply(this, arguments);
};

BHell_Hit_Effect.prototype = Object.create(my.BHell_Sprite.prototype);
BHell_Hit_Effect.prototype.constructor = BHell_Hit_Effect;

BHell_Hit_Effect.prototype.initialize = function (x, y, sprite, index, parent, effectList) {
    var sprite = sprite;
    var index = index;
    var direction = 2;
    var frame = 0;
...
BHell_Hit_Effect.prototype.update = function () {
    my.BHell_Sprite.prototype.update.call(this);
 ...
 */
BHell_Hit_Effect.prototype.destroy = function() {
    if (this.parent != null) {
        this.parent.removeChild(this);
    }
...
var BHell = (function (my) {
    ...
    /**
     * Finisher movement class. Moves towards the center of the screen up to a given distance, then starts orbiting around it.
	 * Modified from the BHell_Mover_Orbit class for the BHell_Mover_Finisher by V.L. 10/11/2020 (see Finisher.js)
     * @constructor
     * @memberOf BHell
     * @extends BHell.BHell_Mover_Base
     */
    var BHell_Mover_Finisher = my.BHell_Mover_Finisher = function () {
        this.initialize.apply(this, arguments);
    };
    ...
    BHell_Mover_Finisher.prototype.initialize = function (direction, radius, counterclockwise, centerX, centerY) {//changed function call to allow us to set center point YA
		...
		this.center_x = centerX || Graphics.width / 2 ; 
		this.center_y = centerY || Graphics.height / 2; 
		this.rotate_speed = 0; 
    ...
    BHell_Mover_Finisher.prototype.move = function (oldX, oldY, speed) {
		...
		if (my.player.justSpawned) {
			...
			if (this.counterclockwise) {
				this.t -= speed * Math.PI / (180 + this.rotate_speed);
			}
			else {
				this.t += speed * Math.PI / (180 + this.rotate_speed);
			}
	...
	/**
     * Moves to a position and stay still.
     * @param oldX Old x coordinate.
     * @param oldY Old y coordinate.
     * @param speed Movement speed (in thousandths of distance between P1 and P2 per frame).
     * @returns {Array}
     */
	var BHell_Mover_Still = my.BHell_Mover_Still = function () {
        this.initialize.apply(this, arguments);
    };

    BHell_Mover_Still.prototype = Object.create(BHell_Mover_Base.prototype);
    BHell_Mover_Still.prototype.constructor = BHell_Mover_Still;
     ...
     */
    BHell_Mover_Still.prototype.initialize = function (x, y, angle, w, h) {
        BHell_Mover_Base.prototype.initialize.call(this);
     ...
     * @returns {Array}
     */
    BHell_Mover_Still.prototype.move = function (oldX, oldY, speed) {
        var ret = [];
...
var BHell = (function (my) {
   ...
   BHell_Player.prototype.initialize = function (id, lives, unlimitedBombs, parent) {
        ...
        this.startingBombs = 1;
        this.bombs = 0; // this.startingBombs; 10/18/2020
		...
		// Added hitbox for player by V.L. 10/18/2020
		this.box = [];
 ...
 * @extends BHell.BHell_Sprite
 */
var BHell_Hitbox = my.BHell_Hitbox = function() {
    this.initialize.apply(this, arguments);
};

BHell_Hitbox.prototype = Object.create(my.BHell_Sprite.prototype);
BHell_Hitbox.prototype.constructor = BHell_Hitbox;

BHell_Hitbox.prototype.initialize = function (x, y, parent, effectList) {
    var sprite = "$Hitbox";
    var index = 1;
	var direction = 2; 
    var frame = 0;
...
BHell_Hitbox.prototype.update = function () {
    my.BHell_Sprite.prototype.update.call(this);
	...
	if (my.map === 32) {
        if (my.player.Twinsmap) {
			if (my.stage.parallaxName() != 'BulletHell_Twins') {
				my.stage.changeParallax('BulletHell_Final_Twins', 0, 0, 0, 0);
			}
