...
var BHell = (function (my) {
    ...
    BHell_Enemy_VictoriaTestimony1_p2.prototype.initialize = function(x, y, image, params, parent, enemyList) {
        params.hp = 75;//change to adjust boss HP
        params.speed = 4; //change to adjust speed of boss moving 
        params.hitbox_w = 442; //change to adjust hitbox width
        params.hitbox_h = 76; //change to adjust hitbox height
        params.animated = false;
        this.frameCounter =1;
        this.state = "started";
        this.bombedWrong =false; //VL change this variable to true if bomb is used incorrectly
...
var BHell = (function (my) {
    ...
    BHell_Enemy_VictoriaTestimony1_p3.prototype.initialize = function(x, y, image, params, parent, enemyList) {
        params.hp = 75;//change to adjust boss HP
        params.speed = 4; //change to adjust speed of boss moving 
        params.hitbox_w = 520; //change to adjust hitbox width
        params.hitbox_h = 82; //change to adjust hitbox height
        params.animated = false;
        this.frameCounter =1;
        this.state = "started";
    ...
    BHell_SDC_Bullet.prototype.update = function () {
        ...
        switch(this.type){
            ...
            if(my.player.Timestop==true){
                ...
                this.flip=this.frameCounter;
            }
            else if(my.player.Timestop==false){
                //this.angle=this.a;
                //this.speed=(-this.speed);
                if(this.frameCounter==this.flip+80){
                    this.speed=(-this.speed);
                    this.type="stoppable";
                }
                this.frameCounter++;
...
//=============================================================================
// Animism Emitter(kinda used mostly just a spray emitter with some of the above custom bullets wanted to do more with it but time wont let me, EDIT:it does alot now)
//=============================================================================
var BHell = (function (my) {
